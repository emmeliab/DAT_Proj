...
aci_files_nm <- list.files(path = "C:/Users/emmel/Desktop/DAT_proj/Stomata Test",
                           pattern = "walkup_aci_clean")
print(aci_files_nm)

for (i in 1:length(aci_files_nm)) {
  files1 <- read_xlsx(path = paste0("C:/Users/emmel/Desktop/DAT_proj/Stomata Test/", 
...
## some columns)
Reduce(setdiff, list(colnames(`data_2022-08-06-1020_walkup_aci_clean_sr.xlsx`), 
        colnames(`data_2022-08-07-0941_walkup_aci_clean_sr.xlsx`),
        colnames(`data_2022-08-08-0854_walkup_aci_clean_sr.xlsx`))) #finds the unique columns
...
`data_2022-08-06-1020_walkup_aci_clean_sr.xlsx` <- `data_2022-08-06-1020_walkup_aci_clean_sr.xlsx` %>% 
  rename("Leaf_position" = "Leaf_Position") %>% 
  rename("Data_QC" = "...244") %>% 
  rmv_stbl()
`data_2022-08-07-0941_walkup_aci_clean_sr.xlsx` <- `data_2022-08-07-0941_walkup_aci_clean_sr.xlsx` %>% 
  rename("Tree_Identifier" = "Tree Identifier") %>% 
  rename("Data_QC" = "...244") %>% 
  rmv_stbl()
`data_2022-08-08-0854_walkup_aci_clean_sr.xlsx` <- `data_2022-08-08-0854_walkup_aci_clean_sr.xlsx` %>% 
  rmv_stbl()



## Fix data columns into the same kind of data
`data_2022-08-06-1020_walkup_aci_clean_sr.xlsx`$"Leaf_position" <- as.numeric(`data_2022-08-06-1020_walkup_aci_clean_sr.xlsx`$"Leaf_position")
`data_2022-08-07-0941_walkup_aci_clean_sr.xlsx`$"Leaf_position" <- as.numeric(`data_2022-08-07-0941_walkup_aci_clean_sr.xlsx`$"Leaf_position")
`data_2022-08-08-0854_walkup_aci_clean_sr.xlsx`$"Leaf_position" <- as.numeric(`data_2022-08-08-0854_walkup_aci_clean_sr.xlsx`$"Leaf_position")

## Merge the data together
all_aci.df <- bind_rows(`data_2022-08-06-1020_walkup_aci_clean_sr.xlsx`,
                        `data_2022-08-07-0941_walkup_aci_clean_sr.xlsx`,
                        `data_2022-08-08-0854_walkup_aci_clean_sr.xlsx`)
...
write.csv(x = complete_sp, file = paste0(getwd(), "/Stomata Test/clean_data_sr.csv"), 
          row.names = FALSE)
