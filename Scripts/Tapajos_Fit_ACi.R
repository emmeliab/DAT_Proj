...
k6718l2_dat_fit_photo <- fit_aci_response(data = DAT_filt_ex[DAT_filt_ex$unique == "K6718L2", ],
...
pdf(file = paste0(wd,"Figures/dat_fit_ex_photo_figs.pdf"), height=10, width=20)
plot.new()
for (curve in 1:33){
