...
#Temperature correction for Photosynthesis package

library(tidyverse)

## Maquelle approach: Photosynthesis WITHOUT TPU ---------------------------------------
...
#change date!
write.csv(dat_corrected, "/Users/charlessouthwick/Documents/GitHub/DAT_Proj/Results/photo_tcorr_noTPU_20220217.csv")
...
write.csv(trad_corrected, "/Users/charlessouthwick/Documents/GitHub/DAT_Proj/Results/photo_tcorr_noTPU_20220217.csv")

#Maquelle approach, photosynthesis WITH TPU ---------------------------------
cmplt.rm_out <- read_csv("~/Documents/GitHub/DAT_Proj/Inputs/Aci_no_out.csv")
...
#change date!
write.csv(dat_corrected, "/Users/charlessouthwick/Documents/GitHub/DAT_Proj/Results/photo_tcorr_withTPU_20220217.csv")
...
#change date
write.csv(trad_corrected, "/Users/charlessouthwick/Documents/GitHub/DAT_Proj/Results/photo_tcorr_withTPU_20220217.csv")
